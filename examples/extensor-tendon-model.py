...
trep.forces.HybridWrench(system, 'C', (-1, 0, -1))
trep.forces.HybridWrench(system, 'E', (0, 0, -1.414))
trep.forces.HybridWrench(system, 'I', (1, 0, -1))
...
# arbitrary systems from the tree structure.  Some additional
# elements, like the spring potentials and wrenches, can also
# automatically draw representations of themselves.
# print_instructions() has the viewer print out basic usage
